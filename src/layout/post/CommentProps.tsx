...
const CommentProps: React.FC<CommentInterface> = ({comments, fullName, avatar, accountId, client, postId}) => {
    ...
    const handleCreateLikeComment = (commentId : number) => {
        if (client) {
            let messageSend = JSON.stringify({
                postId: postId,
                commentId: commentId,
            ...
            <div className="list-comment-area" style={{marginLeft : '30px', padding:'20px'}}>
                {
                    comments.map((comment) => (
                        <div className={'comment-list-area'}  style={{marginBottom : '10px'}}>
                            ...
                            <div className="comment-list-area-bottom" style={{marginLeft : '40px', color: 'rgb(122, 128, 155)', backgroundColor: '#e5e5e5', padding:'10px', borderRadius:'10px'}}>
                                {comment.content}
                            </div>
                            <div style={{marginLeft: '40px', marginTop: '5px', display: 'flex'}}>
                                ...
                                <div style={{marginLeft: '20px', display: 'flex'}}>
                                    ...
                                    <div onClick={() => comment?.commentId !== undefined && handleCreateLikeComment(comment.commentId)}  style={{color: '#7a809b', marginLeft: '5px', fontSize :'14px', cursor:'pointer'}}> Yêu thích ({comment.totalLikeComments})</div>
                                </div>
                                ...
                                <div style={{marginLeft: '20px', display: 'flex'}}>
                                    ...
                                    <div style={{color: '#7a809b', marginLeft: '5px', fontSize :'14px', cursor:'pointer'}}> Phản hồi (0)</div>
                                </div>
