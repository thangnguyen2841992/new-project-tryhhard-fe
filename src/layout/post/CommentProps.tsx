                            ...
                            <div key={comment.commentId} className={'comment-list-area'}  style={{marginBottom : '10px'}}>
                                ...
                                <div style={{marginLeft: '40px', marginTop: '5px', display: 'flex'}}>
                                    ...
                                    <div style={{marginLeft: '20px', display: 'flex'}}>
                                        ...
                                        <div onClick={() => comment?.commentId !== undefined && comment?.accountId !== undefined && handleCreateLikeComment(comment.commentId, comment.accountId)}  style={{color: '#7a809b', marginLeft: '5px', fontSize :'14px', cursor:'pointer'}}> Yêu thích ({comment.totalLikeComments})</div>
                                    </div>
